...
Frontend Developer focused on building clean, user-centered web applications with **React and TypeScript**.

I enjoy designing practical software with clear structure, maintainable code, and strong usability.  
My background in pharmacy gives me a strong interest in projects at the intersection of **healthcare, data, and technology**.

Currently working on modern web applications while expanding toward full-stack development.
